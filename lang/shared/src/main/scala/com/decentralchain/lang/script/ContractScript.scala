package com.decentralchain.lang.script
...
import com.decentralchain.lang.v1.estimator.v3.{DAppEstimation, GlobalDeclarationsCosts, ScriptEstimatorV3}
import com.decentralchain.lang.v1.{BaseGlobal, FunctionHeader}
import monix.eval.Coeval

object ContractScript {

  private val Global: BaseGlobal = com.decentralchain.lang.Global // Hack for IDEA
  ...
  case class ContractScriptImpl(stdLibVersion: StdLibVersion, expr: DApp) extends Script {
    ...
    override val containsArray: Boolean = {
      ...
      (verifierExpr ::: declExprs ::: callableExprs)
        .exists(com.decentralchain.lang.v1.compiler.containsArray)
    }
