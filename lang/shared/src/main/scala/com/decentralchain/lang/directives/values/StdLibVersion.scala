package com.decentralchain.lang.directives.values
import com.decentralchain.lang.directives.{DirectiveDictionary, DirectiveKey}

sealed abstract class StdLibVersion(id: Int) extends DirectiveValue(id.toString, id) with Ordered[StdLibVersion] {
...
case object V9 extends StdLibVersion(9)
...
object StdLibVersion {
  implicit object VersionDic extends DirectiveDictionary[StdLibVersion] {
    ...
    override val all: Iterable[StdLibVersion] = Seq(V1, V2, V3, V4, V5, V6, V7, V8, V9)
