...
import com.decentralchain.lang.ValidationError.ScriptParseError
...
import com.decentralchain.lang.v1.BaseGlobal.{ArrayView, DAppInfo}
import com.decentralchain.lang.v1.compiler.CompilationError.Generic
import com.decentralchain.lang.v1.compiler.ScriptResultSource.CallableFunction
import com.decentralchain.lang.v1.compiler.Terms.EXPR
import com.decentralchain.lang.v1.compiler.Types.FINAL
import com.decentralchain.lang.v1.compiler.{CompilationError, CompilerContext, ContractCompiler, ExpressionCompiler}
import com.decentralchain.lang.v1.estimator.v2.ScriptEstimatorV2
import com.decentralchain.lang.v1.estimator.v3.DAppEstimation
  ...
  def checkExpr(
    ...
    for {
      ...
      illegalBlockVersionUsage = LetBlockVersions.contains(version) &&
        com.decentralchain.lang.v1.compiler.containsBlockV2(expr)
      _ <- Either.cond(
