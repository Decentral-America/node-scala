package com.decentralchain.events.repo

import cats.syntax.monoid.*
import com.decentralchain.common.state.ByteStr
import com.decentralchain.events.{BlockAppended, BlockchainUpdated, MicroBlockAppended}
...
object LiquidState {
  def solidify(keyBlock: BlockAppended, microBlocks: Seq[MicroBlockAppended]): BlockAppended = {
    ...
    BlockAppended(
      ...
      updatedDccAmount = keyBlock.updatedDccAmount,
      vrf = keyBlock.vrf,
