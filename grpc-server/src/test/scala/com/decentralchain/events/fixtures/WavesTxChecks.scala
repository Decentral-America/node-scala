package com.decentralchain.events.fixtures
...
import com.decentralchain.transaction.{Asset, CreateAliasTransaction, DataTransaction, EthereumTransaction, TransactionBase}
