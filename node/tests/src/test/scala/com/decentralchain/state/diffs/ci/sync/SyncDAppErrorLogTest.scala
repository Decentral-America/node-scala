...
import com.decentralchain.lang.v1.compiler.Terms.{CONST_BOOLEAN, EXPR}
...
import com.decentralchain.transaction.TxValidationError.WithLog
...
class SyncDAppErrorLogTest extends PropSpec with WithDomain with OptionValues {
  ...
  val balances: Seq[AddrWithBalance] =
    Seq(invoker, dApp1, dApp2, dApp3).map(acc => AddrWithBalance(acc.toAddress, 10.dcc))

  val settings: DCCSettings = DomainPresets.RideV6
  ...
  property(
    ...
    createTestCase(
      ...
      s"""FailedTransactionError(code = 1, error = AccountBalanceError(VectorMap(3Dg1k4HroTwQavBBxkLEri6V1CJ9XhKpa1Z -> negative dcc balance: 3Dg1k4HroTwQavBBxkLEri6V1CJ9XhKpa1Z, old: 999000010, new: -98900999990)), log = 
         |	@invokedDApp = Address(
         ...
         |	inv = FailedTransactionError(code = 1, error = AccountBalanceError(VectorMap(3Dg1k4HroTwQavBBxkLEri6V1CJ9XhKpa1Z -> negative dcc balance: 3Dg1k4HroTwQavBBxkLEri6V1CJ9XhKpa1Z, old: 999000010, new: -98900999990)), log = 
         |		@invokedDApp = Address(
         |			bytes = base58'3Dc83oxTWPCtL4bsNSDm5cgbg4WrNgVM3gY'
         |		)
         |		@invokedFuncName = "testCase"
  ...
  property(
    ...
    createTestCase(
      ...
      s"""InvokeRejectError(error = AccountBalanceError(VectorMap(3Dg1k4HroTwQavBBxkLEri6V1CJ9XhKpa1Z -> negative dcc balance: 3Dg1k4HroTwQavBBxkLEri6V1CJ9XhKpa1Z, old: 999000010, new: -98900999990)), log = 
         |	@invokedDApp = Address(
         |		bytes = base58'3DRSMN48Mt8fAc5Q1R46rS9VQ48vgBoraFt'
         |	)
         |	@invokedFuncName = "testCase"
