...
import com.decentralchain.lang.Testing
...
import com.decentralchain.state.{BinaryDataEntry, Blockchain, BooleanDataEntry, EmptyDataEntry, Height, IntegerDataEntry, StringDataEntry}
import com.decentralchain.test.*
import com.decentralchain.transaction.smart.script.{ScriptCompiler, ScriptRunner}
  ...
  "ScriptV4" - {
    "DataTransaction entry mapping" in {
      def compile(scriptText: String): Script =
        ScriptCompiler.compile(scriptText, ScriptEstimatorV3.latest).explicitGet()._1
