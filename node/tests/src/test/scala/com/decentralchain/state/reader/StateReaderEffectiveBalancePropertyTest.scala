...
import com.decentralchain.block.Block.PlainBlockVersion
import com.decentralchain.db.WithDomain
import com.decentralchain.db.WithState.AddrWithBalance
import com.decentralchain.features.BlockchainFeatures.*
import com.decentralchain.lagonaki.mocks.TestBlock.create as block
import com.decentralchain.settings.TestFunctionalitySettings.Enabled
import com.decentralchain.settings.DCCSettings
import com.decentralchain.state.diffs.*
import com.decentralchain.state.{BalanceSnapshot, LeaseBalance, Height}
import com.decentralchain.test.*
import com.decentralchain.transaction.TxHelpers.*
import com.decentralchain.transaction.{CommitToGenerationTransaction, Transaction, TxHelpers}
...
class StateReaderEffectiveBalancePropertyTest extends PropSpec with WithDomain {
  ...
  property("correct balance snapshots at height = 2") {
    def assert(settings: DCCSettings, fixed: Boolean) =
