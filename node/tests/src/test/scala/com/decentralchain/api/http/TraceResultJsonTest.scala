...
import com.decentralchain.lang.v1.compiler.Terms.{CONST_LONG, CONST_STRING, FUNCTION_CALL}
...
class TraceResultJsonTest extends PropSpec with JsonMatchers {
  private val tx = (
    for {
      ...
      address   <- Address.fromString("3DXYChnDbVqYY1jC9hnNEUWeUSad28S96iD")
  ...
  property("suitable TracedResult json") {
    ...
    json(result) should matchJson("""{
                                    |  "type": 16,
                                    |  "id": "CZ1SupEWVjkoLdde6ThFwb2nNmwQdRi38UsMnSwSLL34",
                                    ...
                                    |  ],
                                    |  "version": 1,
                                    |  "dApp": "3DXYChnDbVqYY1jC9hnNEUWeUSad28S96iD",
                                    |  "payment": [
                                    |    {
                                    |      "amount": 1,
                                    |      "assetId": null
                                    ...
                                    |    {
                                    |      "type": "dApp",
                                    |      "id": "3DXYChnDbVqYY1jC9hnNEUWeUSad28S96iD",
                                    |      "function": "func",
                                    |      "args": [
                                    |        "param",
                                    |        "1"
                                    ...
                                    |        "transfers": [
                                    |          {
                                    |            "address": "3DXYChnDbVqYY1jC9hnNEUWeUSad28S96iD",
                                    |            "asset": null,
                                    |            "amount": 1
                                    |          }
                                    |        ],
