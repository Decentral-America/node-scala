...
import com.decentralchain.test.BlockchainExt.*
...
class EcrecoverTest extends PropSpec, WithDomain, OptionValues {
  ...
  for {
    ...
    withDomain(
      ...
      d.blockchain
        .stringData(dapp.toAddress, "REC")
        .value shouldBe "0c9af283046995d88527c7acc82dc7f7e5a29a3119d68b8903789541348e008f4d0b8d7d8047c23818ec2063f6299ba469f79245d07d78f2b55f500f5d953e4f"
    }
  }
}
