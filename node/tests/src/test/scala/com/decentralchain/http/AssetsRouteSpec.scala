...
import com.decentralchain.api.http.ApiError.{AssetIdNotSpecified, AssetsDoesNotExist, InvalidIds, TooBigArrayAllocation}
...
class AssetsRouteSpec
  ...
  def routeTest[A](
      settings: DCCSettings = DomainPresets.RideV4.addFeatures(BlockchainFeatures.ReduceNFTFee),
