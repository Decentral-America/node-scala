...
import com.decentralchain.lang.directives.values.V8
...
import com.decentralchain.utils.{EthHelpers, SharedSchedulerMixin}
...
class TransactionSnapshotsRouteSpec
  ...
  override def settings: DCCSettings                 = DeterministicFinality
