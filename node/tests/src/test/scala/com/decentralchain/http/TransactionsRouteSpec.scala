...
import com.decentralchain.api.http.ApiError.{ScriptExecutionError as _, *}
import com.decentralchain.api.http.{CustomJson, RouteTimeout, TransactionsApiRoute}
...
import com.decentralchain.lang.directives.values.{V5, V7, V8}
...
class TransactionsRouteSpec
  ...
  override def settings: DCCSettings = DomainPresets.DeterministicFinality.copy(
      ...
      Get(routePath(s"/address/$richAddress/limit/1")) ~> route ~> check {
        ...
        responseByAddress shouldBe Json.parse(
          s""" [
             ...
             |       "sender": "3DXmkpmwp1KKPrgeayncoj7D3awWcdR3doN",
             ...
             |       "payload": {
             |         "type": "invocation",
             |         "dApp": "3DffkAD4Bs3C22Yjkuf55k53p6kWh7wFipJ",
             |         "call": {
             |           "function": "f",
             |           "args": []
             |         },
