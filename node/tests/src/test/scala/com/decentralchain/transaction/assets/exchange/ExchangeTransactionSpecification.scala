  ...
  property("ExchangeV1 decode pre-encoded bytes") {
    ...
    val json = Json.parse(
      """{
        ...
        |  "sender" : "3DhfBQubGdQpTqnJRVo8ACuAR6oZmrH8TD2",
        |  "feeAssetId" : null,
        ...
        |    "sender" : "3DRqZ3QZyRh92HNtRExjY2wh5V6MsCKprh6",
        ...
        |    "sender" : "3DktBjHNQeNh5WRmu4Drcp7aUwWe2LpdJnc",
  ...
  property("ExchangeV2 decode pre-encoded bytes") {
    ...
    val json = Json.parse(
      """{
        ...
        |  "sender" : "3DTVwUay6Uej5Qw2Yy3bHAygiNrzeH8v2f8",
        |  "feeAssetId" : null,
        ...
        |    "sender" : "3DPhT4bFi2K4D8f5aVNm8HmiFgGtuZKE1Ui",
        |    "price" : 1375940418789,
        ...
        |    "version" : 2,
        |    "matcherFee" : 28043079085937,
        |    "sender" : "3DQkHgCP4rQbP8GkVDxWpRHGnC616Tf7DC7",
        |    "price" : 1375940418789,
