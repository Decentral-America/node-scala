...
import com.decentralchain.state.{BinaryDataEntry, BooleanDataEntry, DataEntry, EmptyDataEntry, IntegerDataEntry}
...
class DataTransactionSpecification extends PropSpec {
  ...
  property("negative validation cases") {
    ...
    forAll(gen) { case DataTransaction(version, sender, data, fee, timestamp, proofs, _) =>
