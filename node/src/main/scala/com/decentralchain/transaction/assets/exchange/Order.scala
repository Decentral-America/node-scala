...
import com.decentralchain.account.{Address, KeyPair, PrivateKey, PublicKey}
...
object Order {
  ...
  implicit lazy val jsonFormat: Format[Order] = com.decentralchain.transaction.assets.exchange.OrderJson.orderFormat
