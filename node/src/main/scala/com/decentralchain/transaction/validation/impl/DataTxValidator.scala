...
import com.decentralchain.state.{BinaryDataEntry, Blockchain, BooleanDataEntry, DataEntry, EmptyDataEntry, IntegerDataEntry, StringDataEntry}
import com.decentralchain.transaction.{DataTransaction, TxValidationError, TxVersion}
import com.decentralchain.transaction.DataTransaction.MaxEntryCount
