...
import com.decentralchain.serialization.{ByteBufferOps, Deser}
import com.decentralchain.transaction.{CreateAliasTransaction, Proofs, Transaction, TxPositiveAmount, TxVersion}
