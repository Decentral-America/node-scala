...
import com.decentralchain.transaction.TxValidationError.{GenericError, InvalidAddress, WrongChain}
import com.decentralchain.utils.{EthEncoding, StringBytes, base58Length}
