...
import com.decentralchain.consensus.PoSCalculator.{generationSignature, hit}
import com.decentralchain.consensus.{FairPoSCalculator, NxtPoSCalculator}
import com.decentralchain.crypto.*
import com.decentralchain.features.{BlockchainFeature, BlockchainFeatures}
import com.decentralchain.settings.*
import com.decentralchain.transaction.{GenesisTransaction, TxNonNegativeAmount}
...
object GenesisBlockGenerator {
  ...
  def createConfig(settings: Settings): String = {
    ...
    com.decentralchain.account.AddressScheme.current = new AddressScheme {
