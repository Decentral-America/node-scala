...
import com.decentralchain.Exporter.Formats
...
import com.decentralchain.database.{DBExt, KeyTag, RDB}
...
import com.decentralchain.state.{BlockEndorser, Blockchain, BlockchainUpdaterImpl, Height, ParSignatureChecker}
...
object Importer extends ScorexLogging {
  ...
  def loadSettings(file: Option[File]): DCCSettings = Application.loadApplicationConfig(file)
