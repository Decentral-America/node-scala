...
import com.decentralchain.account.{Address, AddressOrAlias, AddressScheme, Alias}
...
object InvokeScriptResult {
  type LeaseCancel = com.decentralchain.lang.v1.traits.domain.LeaseCancel
  type SponsorFee  = com.decentralchain.lang.v1.traits.domain.SponsorFee
  type Issue       = com.decentralchain.lang.v1.traits.domain.Issue
  type Reissue     = com.decentralchain.lang.v1.traits.domain.Reissue
  type Burn        = com.decentralchain.lang.v1.traits.domain.Burn
  type DataEntry   = com.decentralchain.state.DataEntry[?]
  ...
  def fromLangResult(invokeId: ByteStr, result: ScriptResult): InvokeScriptResult = {
    import com.decentralchain.lang.v1.traits.domain as lang
