...
import com.decentralchain.account.{Address, AddressOrAlias, PublicKey}
import com.decentralchain.common.state.ByteStr
import com.decentralchain.common.utils.EitherExt2.*
import com.decentralchain.features.BlockchainFeatures
import com.decentralchain.features.BlockchainFeatures.*
import com.decentralchain.features.EstimatorProvider.*
import com.decentralchain.features.InvokeScriptSelfPaymentPolicyProvider.*
import com.decentralchain.features.ScriptTransferValidationProvider.*
...
import com.decentralchain.lang.v1.evaluator.{Log, ScriptResult, ScriptResultV4}
import com.decentralchain.lang.v1.traits.Environment
import com.decentralchain.lang.v1.traits.domain.*
import com.decentralchain.lang.v1.traits.domain.Tx.{BurnPseudoTx, ReissuePseudoTx, ScriptTransfer, SponsorFeePseudoTx}
...
import com.decentralchain.transaction.smart.script.trace.AssetVerifierTrace.AssetContext
import com.decentralchain.transaction.smart.script.trace.TracedResult.Attribute
import com.decentralchain.transaction.smart.script.trace.{AssetVerifierTrace, TracedResult}
import com.decentralchain.transaction.validation.impl.{DataTxValidator, LeaseCancelTxValidator, LeaseTxValidator, SponsorFeeTxValidator}
import com.decentralchain.transaction.{Asset, AssetIdLength, ERC20Address, PBSince, TransactionType}
      ...
      case (TracedResult(Right(currentSnapshot), prevTrace, _), action) =>
        ...
        def applyIssue(itx: InvokeScriptLike, pk: PublicKey, issue: Issue): TracedResult[ValidationError, StateSnapshot] = {
          ...
          if (
            ...
            if (
              blockchain.isFeatureActivated(RideV6) || blockchain.height < blockchain.settings.functionalitySettings.enforceTransferValidationAfter
            ) {
