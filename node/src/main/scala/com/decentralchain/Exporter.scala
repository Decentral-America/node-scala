...
import com.decentralchain.database.protobuf.BlockMeta
import com.decentralchain.database.{KeyTag, RDB, createBlock, readBlockMeta, readTransaction}
...
import com.decentralchain.protobuf.toByteStr
...
object Exporter extends ScorexLogging {
  private[decentralchain] object Formats {
    val Binary   = "BINARY"
