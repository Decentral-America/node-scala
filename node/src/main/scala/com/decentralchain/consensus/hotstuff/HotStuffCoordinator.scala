...
trait HotStuffEffects {
  ...
  /** Sign `voteMessage` as committee slot `voterIndex` under domain-separation tag `dst` (audit H2,
    * see `HotStuffQuorum.VoteDst`), or None if this node doesn't hold that key.
    */
