package com.decentralchain.utils.generator

import com.typesafe.config.{ConfigFactory, ConfigParseOptions}
import com.decentralchain.GenesisBlockGenerator
import com.decentralchain.account.{Address, SeedKeyPair}
import com.decentralchain.block.Block
import com.decentralchain.block.Block.BlockId
import com.decentralchain.consensus.PoSSelector
import com.decentralchain.database.{RDB, RocksDBWriter, loadActiveLeases}
...
import com.decentralchain.state.{BalanceSnapshot, BlockEndorser, BlockchainUpdaterImpl, EndorsementStorage}
import com.decentralchain.transaction.TxValidationError.GenericError
import com.decentralchain.utils.{Schedulers, Time}
  ...
  object BlockchainObjects {
    ...
    def createChallenging(
      ...
      val rocksDBWriter = RocksDBWriter(
        rdb,
        fixedDCCSettings.blockchainSettings,
        fixedDCCSettings.dbSettings,
        isLightMode = false
      )
      ...
      com.decentralchain.checkGenesis(fixedDCCSettings, blockchainUpdater, Miner.StrictDisabledMiner)
      sys.addShutdownHook(synchronized {
        blockchainUpdater.shutdown()
        rdb.close()
      })
    ...
    private def createMinerAndAppender(
        ...
        MinerImpl,
        (
            com.decentralchain.block.Block,
