...
import com.decentralchain.api.common.AddressTransactions.TxByAddressIterator.BatchSize
import com.decentralchain.common.state.ByteStr
import com.decentralchain.database.protobuf.EthereumTransactionMeta
import com.decentralchain.database.{AddressId, DBExt, DBResource, Key, Keys, RDB, readTransactionHNSeqAndType}
import com.decentralchain.state.{Height, InvokeScriptResult, StateSnapshot, TransactionId, TxMeta, TxNum}
import com.decentralchain.transaction.{Authorized, EthereumTransaction, GenesisTransaction, Transaction, TransactionType}
...
object AddressTransactions {
  ...
  def allAddressTransactions(
    ...
    // NOTE: temporary deduplication of diff vs db transactions
