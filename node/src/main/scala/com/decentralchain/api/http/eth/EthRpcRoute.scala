package com.decentralchain.api.http.eth
...
import com.decentralchain.api.http.ApiError.{CustomValidationError, InvalidIds}
import com.decentralchain.api.http.assets.AssetsApiRoute
import com.decentralchain.common.state.ByteStr
import com.decentralchain.state.{Blockchain, TxMeta}
import com.decentralchain.transaction.Asset.IssuedAsset
import com.decentralchain.transaction.TxValidationError.GenericError
import com.decentralchain.transaction.{EthABIConverter, ERC20Address, EthereumTransaction}
import com.decentralchain.utils.EthEncoding.*
import com.decentralchain.utils.{EthEncoding, Time}
                ...
                tm.transaction match {
                  case tx: EthereumTransaction =>
                    Json.obj(
                      ...
                      "blockNumber"       -> toHexString(BigInteger.valueOf(tm.height.toInt)),
