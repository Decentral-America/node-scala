...
import com.decentralchain.api.common.TransactionMeta
import com.decentralchain.api.http.StreamSerializerUtils.*
import com.decentralchain.api.http.TransactionJsonSerializer.*
import com.decentralchain.api.http.TransactionsApiRoute.{ApplicationStatus, LeaseStatus, TxMetaEnriched}
import com.decentralchain.common.state.ByteStr
import com.decentralchain.database.protobuf.EthereumTransactionMeta
import com.decentralchain.database.protobuf.EthereumTransactionMeta.Payload
...
import com.decentralchain.transaction.{Asset, PBSince, Transaction}
  ...
  def transactionMetaJson(meta: TransactionMeta): JsObject = {
    val specificInfo = meta.transaction match {
      case lease: LeaseTransaction =>
        import com.decentralchain.api.http.TransactionsApiRoute.LeaseStatus.*
