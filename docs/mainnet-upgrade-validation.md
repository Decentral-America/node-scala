...
| Period-boundary committedGeneratorsHash in BlockHeader (Step B) | ✅ DONE | Deployed v1.6.3-be2dcfc0 |
| Block appender validation at period boundaries (Step C) | ✅ DONE | Deployed v1.6.3-be2dcfc0 |
