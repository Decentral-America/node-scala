...
import com.decentralchain.api.http.CompositeHttpService
import com.decentralchain.api.{DefaultBlockchainApi, GrpcChannelSettings, GrpcConnector}
...
import com.decentralchain.ride.runner.db.RideRocksDb
import com.decentralchain.ride.runner.entrypoints.settings.RideRunnerGlobalSettings
import com.decentralchain.ride.runner.http.{EvaluateApiRoute, HttpServiceStatus, ServiceApiRoute}
import com.decentralchain.ride.runner.requests.{DefaultRequestService, RideScriptRunRequest, SynchronizedJobScheduler}
import com.decentralchain.ride.runner.stats.RideRunnerStats
import com.decentralchain.ride.runner.{BlockchainProcessor, BlockchainState}
...
object DCCRideRunnerWithBlockchainService extends ScorexLogging {
