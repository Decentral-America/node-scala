...
import com.decentralchain.api.RideMulticastHttpApi
...
import com.decentralchain.ride.runner.http.{HttpServiceStatus, ServiceApiRoute}
...
object DCCRideRunnerCompareService extends ScorexLogging {
  case class Settings(
