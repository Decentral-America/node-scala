...
import com.decentralchain.ride.runner.caches.disk.KvHistoryPair
import com.decentralchain.ride.runner.db.Heights.{splitHeightsAt, splitHeightsAtRollback}
...
trait ReadWrite extends ReadOnly {
  ...
  def removeFromAndGetLatestExisted[K, V](
      k: K,
