package com.decentralchain.database.rocksdb

import com.google.common.primitives.{Bytes, Ints, Longs, Shorts}
import com.decentralchain.database.AddressId
import com.decentralchain.state.TxNum
...
object KeyHelpers {
  ...
  def hNum(height: Int, num: TxNum): Array[Byte] = Bytes.concat(Ints.toByteArray(height), Shorts.toByteArray(num.toShort))
  ...
  def bytesSeqNr(keyTag: KeyTag, suffix: Array[Byte], default: Int = 0): Key[Int] =
