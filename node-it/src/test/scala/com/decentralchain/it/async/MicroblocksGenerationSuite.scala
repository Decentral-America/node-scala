package com.decentralchain.it.async

import com.typesafe.config.{Config, ConfigFactory}
import com.decentralchain.it.api.AsyncHttpApi.*
import com.decentralchain.it.{BaseFreeSpec, LoadTest, NodeConfigs, TransferSending}
...
object MicroblocksGenerationSuite {
  ...
  private val ConfigOverrides = ConfigFactory.parseString(s"""dcc {
                                                             |    miner {
                                                             |      quorum = 0
