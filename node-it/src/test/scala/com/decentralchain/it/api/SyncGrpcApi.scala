...
import com.decentralchain.it.api.SyncHttpApi.RequestAwaitTime
...
object SyncGrpcApi extends Assertions {
  ...
  implicit class NodeExtGrpc(n: Node) {
    ...
    import com.decentralchain.account.Address as Addr
    import com.decentralchain.it.api.AsyncGrpcApi.NodeAsyncGrpcApi as async
    ...
    def stateChanges(request: TransactionsRequest): Seq[(com.decentralchain.transaction.Transaction, StateChangesDetails)] = {
