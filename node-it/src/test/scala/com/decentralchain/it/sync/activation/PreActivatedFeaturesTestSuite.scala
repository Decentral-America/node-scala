...
import com.decentralchain.features.api.NodeFeatureStatus
import com.decentralchain.features.{BlockchainFeatureStatus, BlockchainFeatures}
import com.decentralchain.it.api.SyncHttpApi.*
import com.decentralchain.it.{BaseFreeSpec, Docker}
...
object PreActivatedFeaturesTestSuite {
  ...
  private val supportedConfig = ConfigFactory.parseString(s"""dcc {
                                                             ...
                                                             |  miner.quorum = 1
                                                             |}""".stripMargin)
  private val preactivatedConfig = ConfigFactory.parseString(s"""dcc {
                                                                |  blockchain.custom.functionality {
                                                                |  feature-check-blocks-period = $votingInterval
                                                                |  pre-activated-features {
                                                                |        1 = 0
