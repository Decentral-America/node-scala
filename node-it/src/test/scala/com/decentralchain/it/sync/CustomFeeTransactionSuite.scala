...
import com.decentralchain.state.{Height, Sponsorship}
...
class CustomFeeTransactionSuite extends BaseTransactionSuite with CancelAfterFailure {
  ...
  import CustomFeeTransactionSuite.*
...
object CustomFeeTransactionSuite {
  ...
  private val assetTx = TxHelpers.issue(issuer = senderKeyPair, amount = defaultAssetQuantity, decimals = 2, name = "asset", description = "asset description", fee = 1.dcc, script = None, reissuable = false, version = TxVersion.V1)
