...
import com.decentralchain.api.http.ApiError.{CustomValidationError, TooBigArrayAllocation}
...
class AddressApiSuite extends BaseTransactionSuite with NTPTime {
  ...
  override protected def nodeConfigs: Seq[Config] =
    Seq(BiggestMiner.quorum(0).overrides("dcc.rest-api.transactions-by-address-limit = 20"), NotMiner)
}
